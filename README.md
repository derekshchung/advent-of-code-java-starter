...
A project to get you started solving the [Advent of Code 2021](https://adventofcode.com/2021) challenge in Java.
...
1. Create `Day02Test.java` and use the sample input/output from adventofcode.com/2021/day/2 to write tests (they will initially fail).
...
1. When the example input passes, get your solution from adventofcode.com/2021/day/2/input and save it as `src/main/resources/day02.txt`
...
1. Add new tests for part 2 to `Day02Test.java` using the sample input/output from adventofcode.com/2021/day/2
